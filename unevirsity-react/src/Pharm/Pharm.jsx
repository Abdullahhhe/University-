...
export default function Information() {
  ...
  const images = [
    "images/photo_2025-04-18_00-18-26.jpg",
    "images/photo_2025-04-18_00-18-31 (2).jpg",
    "images/photo_2025-04-18_00-18-31.jpg",
    "images/photo_2025-04-18_00-18-29.jpg",
  ];
  let cur = 0;
  function img() {
    ...
    <div className="Phisecal">
      <div className="ima">
        ...
        <div className="Pa">
          <p
            onClick={() => {
              window.location.pathname = "/NamePharm";
            }}
          >
      ...
      <div className="text">
        ...
        <button
          onClick={() => {
            window.location.pathname = "/PharmMt";
          }}
        >
          {" "}
          المواد الجامعية
